...
#        self.forecastErrors.setReadOnly(True)
        ...
        self.lockMaxLevel = QCheckBox('Lock max lvl')
        self.autoStep = QCheckBox('Auto next step')
        self.enableToolbar = QCheckBox('Graph constrols')
        self.plotMultiline = QCheckBox('Multiline wavelist')
        self.autoBaseSWT = QCheckBox("Process nodes")
        self.autoUpdateTools = QCheckBox('Update R workspace')
        self.showStacktrace = QCheckBox('Show stacktrace')
        self.saveLastFolder = QCheckBox('Remember last opened')
        self.hidetoTray = QCheckBox('Hide to tray')
        self.autoUpdateTable = QCheckBox('Update table')
        self.autoConstructModel = QCheckBox('Model in one click')
